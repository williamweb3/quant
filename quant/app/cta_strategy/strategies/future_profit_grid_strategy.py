from quant.app.cta_strategy import (
    CtaTemplate,
    StopOrder,
    TickData,
    BarData,
...
from quant.app.cta_strategy.engine import CtaEngine
from quant.trader.event import EVENT_TIMER
from quant.event import Event
from quant.trader.object import Status, Direction
from quant.trader.object import GridPositionCalculator
