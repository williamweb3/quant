...
from quant.trader.event import (
    EVENT_TICK,
    EVENT_ORDER,
    EVENT_TRADE,
    EVENT_POSITION
...
from quant.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from quant.trader.database import database_manager
from quant.trader.converter import OffsetConverter
...
class StrategyEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(path1, "quant.app.portfolio_strategy.strategies")
