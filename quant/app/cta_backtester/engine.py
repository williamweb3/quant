...
from quant.trader.engine import BaseEngine, MainEngine
from quant.trader.constant import Interval
from quant.trader.utility import extract_vt_symbol
from quant.trader.object import HistoryRequest
from quant.trader.database import database_manager
from quant.app.cta_strategy import CtaTemplate
from quant.app.cta_strategy.backtesting import BacktestingEngine, OptimizationSetting
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(
            path1, "quant.app.cta_strategy.strategies")
